...
final class AxHomeDocumentItemView: NSColorView {
    ...
    private func onItemModelLoaded() {
        ...
        if let thumbnail = itemModel.data.thumbnail {
        ...
        self.titleLabel.endEditingStringPublisher
            .sink{ itemModel.rename($0) }.store(in: &objectBag)
    ...
    private func showMenu() {
        ...
        menu.addItem("Open", action: { itemModel.openItem() })
